...
const Mousetrap = window.require('mousetrap'); // seems to be necessary. Would much rather use import, but hey, can't have everything.
...
ipcRenderer.on('menu-settings', function () {
	window.App.showSettings();
});
ipcRenderer.on('menu-new_download', function () {
	window.App.show();
});
ipcRenderer.on('menu-close', function () {
	window.App.close();
});
ipcRenderer.on('menu-contact', function () {
	window.App.contact();
});
	...
	render() {
		return (
			<div className="wrapper">
				...
				<div className="App">
					<header>
						<Tool shortcut="+" onClick={() => this.showPrompt()} icon={"fas fa-plus"}/>
						<Tool shortcut="*"
							...
							<div className={"menu"}>
								<div className={"submenu"}>
									...
									<div className={"options"}>
										<div onClick={() => this.showPrompt()} className={"option"}>
											New Download
							...
							<div className={"prompt_content_container"}>
								<div className={"prompt_content_wrapper"}>
									<header className={"prompt_header"}>
										...
										<div className={"prompt_close_button"}>
											<Tool icon={"fas fa-times"}
												  onClick={() => this.setState({pastDownloadsVisible: false})}/>
