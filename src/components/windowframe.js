								...
								<div className="nav_bar_wrapper">
									...
									<div className="nav_item">Help
										<div className="nav_dropdown">
											...
											<div
												onClick={e => _electron.ipcRenderer.send('openURL', "https://github.com/jbis9051/quick_download")}>Learn
												More
											</div>
											<div
												onClick={e => _electron.ipcRenderer.send('openURL', "https://github.com/jbis9051/quick_download")}>Contribute
											</div>
											<div onClick={e => this.props.about()}>About</div>
											<div
												onClick={e => _electron.ipcRenderer.send('openURL', "https://github.com/jbis9051/quick_download")}>Docs
											</div>
										</div>
									</div>
								</div>
